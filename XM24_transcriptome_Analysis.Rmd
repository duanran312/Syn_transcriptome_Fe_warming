...
```{r, include=FALSE}
workdir="/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24"
setwd(workdir)
...
outdir <- file.path(workdir, "output_whole_2", fsep = "/")
gff_file <- "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/XM24_Copy.gff"
count_file=paste(workdir, "featureCounts_result_whole_XM24.csv", sep="/")
metadata_file=paste(workdir, "metadata_XM_2.tsv", sep="/")
...
write.csv(annotations, "G:\\USC\\synecho\\10_DE_analysis_XM24\\annotations.csv", row.names = FALSE)
write.csv(other_gff, "G:\\USC\\synecho\\10_DE_analysis_XM24\\other_gff.csv", row.names = FALSE)
annotations <- read.csv(file="G:\\USC\\synecho\\10_DE_analysis_XM24\\annotations.csv")
#View(annotations)
#head(annotations)
...
```{r}
rawCounts <- read.csv(file = "featureCounts_result_whole_XM24_2.csv", header = T,check.names = F,na.string=0)
#fix(rawCounts)
#head(rawCounts)
#ncol(rawCounts)
...
pheatmap(vst_dist_mat, col=colors, main = "vst Euclidean distance",filename = "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/XM24_sample_vst_plot_heatmap.pdf")
pheatmap(rlog_dist_mat, col=colors, main = "rlog Euclidean distance",filename = "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/XM24_sample_rlog_plot_heatmap.pdf")
oldpar <- par()
par(oldpar)
...
# Read the data
de_gene_counts <- read.csv("/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/DE_gene_counts.csv")
...
file_path <- "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/DE_gene_counts_plot.pdf"

# Save the plot as a PDF
ggsave(file_path, plot = DE_gene_counts_plot, width = 11, height = 8, units = "in")
...
# read the data
ko_data <- read.csv("/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/ko_annotation_XM.csv")
...
files_to_analyze <- list.files(path = "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/", pattern = "*.tsv", full.names = TRUE)
...
##create bar plot
output_folder <- "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/KEGG_enrich/"
...
folder_path <- "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2"

# Get a list of all file names in the folder
file_names <- list.files(path = "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/", pattern = "*.tsv", full.names = TRUE)
...
eggnog_data <- read.csv("/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/eggnog_results.csv")
ko_data <- read.csv("/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/ko_annotation_XM.csv")
...
write.csv(combined_data, "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/annotated/DEG_anno_XM_1.csv", row.names = FALSE)
...
write.csv(combined_data, "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/annotated/log2FC_all.csv", row.names = FALSE)
...
deg_anno_yx_1 <- read.csv("/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/annotated/DEG_anno_XM_1.csv", stringsAsFactors = FALSE)
log2fc_all <- read_excel("/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/annotated/log2FC_all.xlsx")
...
output_dir <- "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/annotated"  # Specify your output directory
...
write.csv(final_results, "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/annotated/top20.csv", row.names = FALSE)
...
folder_path <- "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/annotated/pathway"
...
output_dir <- "/Users/randuan/Documents/USC/synecho/transcriptomes/10_DE_analysis_XM24/output_whole_2/FC2/annotated/pathway"
...
for (df_name in names(merged_data_list)) {
    ...
    ggsave(file_path, plot = p, width = 10, height = 8, units = "in", dpi = 300)
}
```
